...
tags: [Visualization]
embedding_path: /assets/tax_brackets/Tax_Paid_Across_Tax_Brackets.html
---
![](/assets/tax_brackets/2021_taxable_income_vs_taxes_paid_single.png)
...
Anyway, a concept that has been foggy in my mind over the past few years has to do with **tax brackets**. I've heard well-off people mention things like, "When you're in our tax bracket, more than a third of your income goes to taxes." Wow.

My natural inclination has been to think, "Well, maybe it's not so bad that I'm not in a higher tax bracket then."

Finally, I decided to get to the bottom of it and finally answer the question: **is it bad to move to a higher tax bracket?** Thankfully, the answer is no! The graph at the top of the page is the punchline of this post, but I will flesh out the details in what follows.
...
For example, suppose your taxable income came to is $60,872. If you are filing as a single (non-married) person, you can look up your tax obligation at the appropriate place in the table, which came to $9,141, as shown below.
...
For example, if you are filing as a single person and your taxable income was $200,000, then the resulting tax you owe is $200,000 * 0.32 - $19,173 = $44,827, per the second row of the table above.
...
Here's how much taxes were paid by different levels of taxable income, with the red dotted lines representing the various tax brackets for single people.

![2021 Taxable Income vs Taxes Paid - Single](/assets/tax_brackets/2021_taxable_income_vs_taxes_paid_single.png)

Here's the same idea but for those with filing status "married filing jointly."

![2021 Taxable Income vs Taxes Paid - Married Filing Jointly](/assets/tax_brackets/2021_taxable_income_vs_taxes_paid_mfj.png)
...
2. There is a tax advantage for being married. If you compare the two graphs above closely, that for the same taxable incomes, the tax obligation is less for married couples filing jointly compared to single people.
